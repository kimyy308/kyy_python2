...
/*frompyobj*/
  ...
  if (capi_varin_tmp == NULL) {
    ...
    PyErr_SetString(exc ? exc : creep_error,"failed in converting 1st argument `varin' of creep.cslf to C/Fortran array" );
  ...
  if (capi_varout_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : creep_error,"failed in converting hidden `varout' of creep.cslf to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_varin_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : creep_error,"failed in converting 1st argument `varin' of creep.smooth to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    varin = (double *)(PyArray_DATA(capi_varin_tmp));
  ...
  if (capi_mask_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : creep_error,"failed in converting 2nd argument `mask' of creep.smooth to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_varout_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : creep_error,"failed in converting hidden `varout' of creep.smooth to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    varout = (double *)(PyArray_DATA(capi_varout_tmp));
...
PyMODINIT_FUNC PyInit_creep(void) {
  ...
  import_array();
  if (PyErr_Occurred())
    {PyErr_SetString(PyExc_ImportError, "can't initialize module creep (failed to import numpy)"); return m;}
  d = PyModule_GetDict(m);
  s = PyUnicode_FromString("1.21.0");
  PyDict_SetItemString(d, "__version__", s);
  Py_DECREF(s);
  s = PyUnicode_FromString(
    "This module 'creep' is auto-generated with f2py (version:1.21.0).\nFunctions:\n"
...
".");
   ...
   */
  PyDict_SetItemString(d, "_creep_error", creep_error);
  Py_DECREF(creep_error);
