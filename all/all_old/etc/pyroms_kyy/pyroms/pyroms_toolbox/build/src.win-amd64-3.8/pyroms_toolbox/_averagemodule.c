...
/*frompyobj*/
  ...
  if (capi_dataset_tmp == NULL) {
    ...
    PyErr_SetString(exc ? exc : _average_error,"failed in converting 1st argument `dataset' of _average.avg3d to C/Fortran array" );
  ...
  if (capi_incavg_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _average_error,"failed in converting 2nd argument `incavg' of _average.avg3d to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_avg_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _average_error,"failed in converting hidden `avg' of _average.avg3d to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_dataset_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _average_error,"failed in converting 1st argument `dataset' of _average.avg2d to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    dataset = (double *)(PyArray_DATA(capi_dataset_tmp));
  ...
  if (capi_incavg_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _average_error,"failed in converting 2nd argument `incavg' of _average.avg2d to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    incavg = (double *)(PyArray_DATA(capi_incavg_tmp));
  ...
  if (capi_avg_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _average_error,"failed in converting hidden `avg' of _average.avg2d to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    avg = (double *)(PyArray_DATA(capi_avg_tmp));
...
PyMODINIT_FUNC PyInit__average(void) {
  ...
  import_array();
  if (PyErr_Occurred())
    {PyErr_SetString(PyExc_ImportError, "can't initialize module _average (failed to import numpy)"); return m;}
  d = PyModule_GetDict(m);
  s = PyUnicode_FromString("1.21.0");
  PyDict_SetItemString(d, "__version__", s);
  Py_DECREF(s);
  s = PyUnicode_FromString(
    "This module '_average' is auto-generated with f2py (version:1.21.0).\nFunctions:\n"
...
".");
   ...
   */
  PyDict_SetItemString(d, "__average_error", _average_error);
  Py_DECREF(_average_error);
