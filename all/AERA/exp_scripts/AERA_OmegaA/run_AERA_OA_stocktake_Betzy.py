...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        ...
        type=Path,
        help=(
            "CSV containing annual OmegaA for the just-finished segment. "
            "Required columns: year and metric column."
        ),
    )
    p.add_argument(
        "--metric-column",
    ...
    p.add_argument(
        ...
        default=(
            ...
            "emissions-cmip6_CO2_anthro_surface_AERA_OmegaA_hist_nird_2015-2019_"
...
def main() -> None:
    ...
    print("============================================================")
    print(f"Read model OmegaA for {y1}-{y2}")
    print("============================================================")
