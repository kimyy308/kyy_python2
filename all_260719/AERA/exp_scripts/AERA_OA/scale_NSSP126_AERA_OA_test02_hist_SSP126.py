...
# AERA-OA annual fossil-fuel emission output
AERA_CSV = (
...
with Dataset(OUT_FILE, "r+") as ds:
    ...
    ds.setncattr("AERA_branch", "OmegaA")
    ...
    ds.setncattr(
        ...
        (
            ...
            f"{target_start}-{target_end} were replaced using AERA-OA "
